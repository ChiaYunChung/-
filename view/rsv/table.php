...
function user_t($rec) //使用者個人預約
{
    ...
    foreach ($rec as $sin) { //<td>'. $sin['review_state'] .'</td>
        echo '<tr>
                    ...
                    <td>
                        <a href="../../control/rsvget.php?cancel=' . $sin['id'] . '">
    ...
    /*foreach ($rec as $sin) { 
        ...
        echo '
                ...
                <td>
                        ...
                        <button type="button" class="btn btn-primary">失敗</button></a>
                        <a href="../../control/rsvget.php?id=' . $sin['id'] . '&type=cfin&id">
        ...
        echo '<tr>
            <td>' . $sin['id'] . '</td>
                    ...
                    <td>
                        ...
                        <a href="../../control/rsvget.php?type=cnok&id=' . $sin['id'] . '">
